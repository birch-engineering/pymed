...
def test_convert_sent_to_word():
    ...
    sentences = [
        ...
        "Off-Topic Area => General Off-Topic Board => Topic started by: The Poster on December 15, 2005, 08:22 PM",
    ...
    references = [
        ...
        "OFF TOPIC AREA  GENERAL OFF TOPIC BOARD  TOPIC STARTED BY THE POSTER ON DECEMBER FIFTEEN TWO THOUSAND AND FIVE EIGHT O'CLOCK TWENTY TWO MINUTES PM",
